...
const AboutUsHeader: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="sm:ml-24 mt-24 space-y-4 sm:items-center">
        ...
        <h1
          className={`${casualBrush.className} mb-8 text-8xl uppercase sm:text-start sm:text-9xl md:tracking-wider 2xl:mb-24 2xl:text-[200px] w-full flex ml-5`}
        >
          {mainText}
